...
<?php
  ...
  $playlist_id = isset($_GET['playlist']) ? $_GET['playlist'] : 0;
  if ($playlist_id == 0) {
    exit();
  }
  $html = '';
  $aMusic = array();
  $sql = "SELECT music FROM playlistdetail where playlist = ".$playlist_id;
...
?>
    ...
    <?php include __DIR__.'\assets\javascript\main_playlist.php';?>
</body>
