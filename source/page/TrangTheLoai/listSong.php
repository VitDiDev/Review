                    ...
                    <div class="header">
                        ...
                        <div class="header__right">
                            ...
                            <div class="header__user">
                                <img style="margin-top: 7px !important;" src="./img/user/0.jpg" alt="" class="header__user-img">
                    ...
                    <div class="option-all__playlist
                        ...
                        <ul class="option-all__playlist-list">
                            <div class="row">
                                ...
                                </div><div class="col l-2-4 m-4 s-6
                                        mobile-margin-bot-30px">
                                    <li class="option-all__playlist-item
                                            option-all__playlist-item-margin_top">
                                        <div class="option-all__playlist-item-img-wrapper
...
<?php
  ...
  $html = '';
  $aMusic = array();
  $sql = "SELECT music FROM musiccategory where category = ".$category;
  $result = $dbCon->query($sql);
  if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        array_push($aMusic, $row["music"]);
    }
  }
  if ($aMusic) {
    $sql = 'SELECT music.image, music.name, singer.name as singer, music.src, music.duration 
            FROM music, singer, musicsinger 
            WHERE music.id in ('.implode(",",$aMusic).') and music.id = musicsinger.music 
