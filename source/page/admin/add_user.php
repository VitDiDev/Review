...
if (mysqli_num_rows($result) > 0) {
    ...
    if($crypt==$user["password"] && $email==$user["email"]){
        ...
        $result= mysqli_query($dbCon,$sql);
        $_SESSION["success"] = "Đã kích hoạt lại tài khoản thành công.";
        header("Location: ./index.php");
        exit();
    }
    else{
        $_SESSION["success"] = "Đăng ký thất bại vui lòng nhập lại thông tin đăng nhập lúc trước để kích hoạt lại tài khoản.";
